...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        if (args == null) {
            ...
            System.out.println("Syntax: .exc [-d dir | -f file] -o output");
            return;
        }
        if (args.length != 4) {
            System.out.println("Error Syntax incorrect");
        ...
        if (!args[0].equals("-d") && !args[0].equals("-f")) {
            System.out.println("Error Syntax incorrect");
            System.out.println("Syntax: .exc [-d dir | -f file] -o output");
            return;
        }
        ...
        if (!Files.exists(in)) {
            System.out.println("Could not read input path");
            System.out.println("Syntax: .exc [-d dir | -f file] -o output");
            return;
        }
        Path out = Paths.get(args[3]);
        if (!Files.exists(out)) {
            System.out.println("Could not read output path");
            System.out.println("Syntax: .exc [-d dir | -f file] -o output");
            return;
        }
        ...
        if (args[0].equals("-f")) {
            ...
            inputDir = input.substring(0, lastSlash);
